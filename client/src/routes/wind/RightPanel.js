...
class RightPanel extends React.Component {
  ...
  render() {
    ...
    const lastDirection = events.slice(-1)[0].direction;
    const lastBeaufortValue = events.slice(-1)[0].beaufort;

    return (
      <>
        <WindStatus name={name} />
        <WindCard header={parseDirection(lastDirection)}>
          <svg width="163" height="100%" maxheight="163" viewBox="0 0 163 163">
            ...
            <path
              className={s.arrow}
              style={this.getRotationDegree(lastDirection)}
        ...
        <WindCard header={parseBeaufortValue(lastBeaufortValue)}>
          <svg width="180" height="100%" maxheight="134" viewBox="0 -20 90 170">
            ...
            <path
              ...
              style={this.getAnimation(lastBeaufortValue)}
